                     ...
                     <table>
                       ...
                       <tr>
                         <td>
                           <p
                             style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                           <p>Atentamente, <br />Equipo HOTEL API</p>
                           </p>
                         </td>
                       </tr>
                       <tr>
                       ...
                       <tr>
                         <td>
                           <table style="width:100%">
                             <tr>
                               <td
                                 style="width:60%;text-align:center;background:#4285f4;padding:15px 20px 15px 20px;border-radius:12px;">
                                 <a href="#"
